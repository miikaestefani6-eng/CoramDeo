...
const faqs = [
  ...
  ["Como funciona a assinatura?", "A assinatura custa R$ 24,99 por mês e o pagamento é processado pela Kiwify."],
    ...
    <main className="min-h-screen bg-[#F2EBDD] text-[#11151A]">
      <header className="sticky top-0 z-50 border-b border-white/8 bg-[#080D13]/90 text-white backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 md:px-8">
          ...
          <div className="flex items-center gap-2"><Link href="/login" className="hidden rounded-full border border-white/15 px-5 py-2.5 text-xs font-semibold text-white sm:inline-flex">Entrar</Link><Link href="/assinatura" className="rounded-full bg-[#D5B579] px-5 py-2.5 text-xs font-bold text-[#11151A] transition hover:bg-[#E4C58C]">Assinar agora</Link></div>
        </div>
      </header>
      ...
      <section id="top" className="relative overflow-hidden bg-[#080D13] text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 py-20 md:px-8 md:py-28 lg:grid-cols-[.9fr_1.1fr] lg:py-32">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[.28em] text-[#D5B579]">Diante da Palavra. Diante de Deus.</p>
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">O Coram Deo une estudo bíblico, devocionais e ferramentas de continuidade para ajudar você a compreender as Escrituras com profundidade, clareza e propósito.</p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row"><a href="#exemplo" className="rounded-full bg-[#D5B579] px-7 py-4 text-center text-sm font-bold text-[#11151A] transition hover:bg-[#E7C98F]">Experimentar uma pesquisa ↓</a><a href="#zion" className="rounded-full border border-white/15 px-7 py-4 text-center text-sm font-semibold text-white/85 transition hover:border-[#D5B579]/60">Conhecer o Zion</a></div>
            <div className="mt-8 flex flex-wrap gap-3 text-[11px] text-white/50"><span>◈ 16 camadas</span><span>◈ Contexto e evidências</span><span>◈ Hebraico e grego</span><span>◈ Aplicação para a vida real</span></div>
          </div>
      ...
      <section id="planos" className="bg-[#EAE0CF] px-5 py-20 md:px-8 md:py-28"><div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[.8fr_1.2fr] lg:items-center"><div><p className="text-[11px] font-bold uppercase tracking-[.28em] text-[#8B6A34]">Comece hoje</p><h2 className="mt-4 font-serif text-4xl font-semibold leading-[1.02] sm:text-5xl">Leve sua rotina de estudo para outro nível.</h2><p className="mt-5 max-w-xl text-sm leading-7 text-[#5C554B]">Uma assinatura simples para acessar a experiência Coram Deo e continuar sua jornada com profundidade e constância.</p></div><div className="rounded-[34px] bg-[#111820] p-8 text-white shadow-[0_28px_90px_rgba(37,30,21,.18)] md:p-10"><p className="text-[11px] font-bold uppercase tracking-[.24em] text-[#D5B579]">Plano Coram Deo</p><p className="mt-5 font-serif text-5xl font-semibold text-[#F8F2E8]">R$ 24,99<span className="ml-2 font-sans text-sm font-normal text-white/45">/mês</span></p><div className="mt-7 grid gap-3 text-sm text-white/65 sm:grid-cols-2">{['Pesquisa com Zion','16 camadas de estudo','Devocionais','Biblioteca','Anotações e favoritos','Planos de leitura'].map(item => <div key={item} className="flex gap-2"><span className="text-[#D5B579]">✓</span>{item}</div>)}</div><Link href="/assinatura" className="mt-8 inline-flex w-full justify-center rounded-full bg-[#D5B579] px-7 py-4 text-sm font-bold text-[#11151A] transition hover:bg-[#E7C98F]">Assinar o Coram Deo →</Link><p className="mt-4 text-center text-[11px] text-white/35">Pagamento processado pela Kiwify.</p></div></div></section>
