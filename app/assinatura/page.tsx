        ...
        <section className="mt-8 overflow-hidden rounded-[30px] bg-[#0F2131] p-7 text-white shadow-[0_18px_50px_rgba(15,33,49,0.14)] sm:p-10 lg:grid lg:grid-cols-[1.1fr_.9fr] lg:gap-10 lg:p-14">
          <div>
            ...
            <div className="mt-8 space-y-3 text-sm text-white/75">
              <p>✓ Biblioteca Essencial</p>
              <p>✓ Acesso ao aplicativo</p>
              <p>✓ Até 30 pesquisas por dia</p>
              <p>✓ Estudos em camadas de compreensão</p>
            </div>
          </div>
          ...
          <div className="mt-8 rounded-3xl bg-white p-6 text-[#0F2131] shadow-xl lg:mt-0 lg:p-8">
            ...
            <div className="mt-4 flex items-end gap-2">
              <span className="font-serif text-5xl font-bold">R$ 19,90</span>
              <span className="pb-2 text-sm text-[#5E6E82]">no 1º mês</span>
            </div>
            ...
            <button onClick={checkout} disabled={loading} className="mt-6 w-full rounded-xl bg-[#8C183F] px-5 py-3.5 text-sm font-bold text-white transition hover:bg-[#731333] disabled:cursor-wait disabled:opacity-60">
              {loading ? "Preparando checkout…" : "Assinar Coram Deo Essencial"}
            </button>
